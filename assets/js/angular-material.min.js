...
! function(e, t, n) {
                    ...
                    disableScrollAround: function(e, n) {
                        function r(e) {
                            ...
                            return e.appendChild(r[0]), r.on("wheel", n), r.on("touchmove", n),
                                function() {
                                    r.off("wheel"), r.off("touchmove"), r[0].parentNode.removeChild(r[0]), delete E.disableScrollAround._enableScrolling
                                }
                        }
    ...
    function() {
        ! function() {
            ...
            var f, g, b, E = /(-gt)?-(sm|md|lg|print)/g,
                v = /\s+/g,
    ...
    function() {
        function e(e) {
            ...
            function p(e, o) {
                ...
                function i(n, i) {
                    function a() {
                        return c = i.controller("mdTheme") || n.data("$mdThemeController"), c && c.$mdTheme || ("default" == v ? "" : v)
                    }
    ...
    function() {
        ...
        function n(e) {
            function n(e, n, i, a, d, c, s) {
                function l(o, r, s, l) {
                    r = i.extractElementByName(r, "md-bottom-sheet"), r.attr("tabindex", "-1"), s.disableBackdrop || (p = i.createBackdrop(o, "md-bottom-sheet-backdrop md-opaque"), p[0].tabIndex = -1, s.clickOutsideToClose && p.on("click", function() {
            ...
            function d(d, s) {
                ...
                return s.type = "checkbox", s.tabindex = s.tabindex || "0", d.attr("role", s.type), d.on("click", function(e) {
                    ...
                    function(d, s, l, u) {
                        ...
                        function g() {
                            u.$viewValue && !E ? s.addClass(c) : s.removeClass(c)
                        }

                        function b(e) {
                            E = e !== !1, E && s.attr("aria-checked", "mixed"), s.toggleClass("md-indeterminate", E)
                        }
                        var E;
            ...
            function r(e, o, r, d, c, s, l, m, u, p) {
                ...
                function M(e, t) {
                    var n = "alert" === t.$type ? "alertdialog" : "dialog",
                        ...
                        c = e.attr("id"),
                        s = "dialogContent_" + (c || r.nextUid());
                    e.attr({
                        role: n,
                        tabIndex: "-1"
                    }), 0 === d.length && (d = e, c && (s = c)), d.attr("id", s), e.attr("aria-describedby", s), t.ariaLabel ? o.expect(e, "aria-label", t.ariaLabel) : o.expectAsync(e, "aria-label", function() {
                    ...
                    i.addEventListener("focus", l), a.addEventListener("focus", l), e[0].parentNode.insertBefore(i, e[0]), e.after(a)
                }
    ...
    function() {
        ! function() {
            function e(e, n, o, r, i, a) {
                ...
                function s(e) {
                    "click" == e.type && w(e), "focusout" != e.type || S || (S = a(function() {
                        _.close()
    ...
    function() {
        ...
        function r(e, n, o) {
            function r(r, i, a, d) {
                ...
                if (m) {
                    if ("hidden" === a.type) return void i.attr("aria-hidden", "true");
                    ...
                    r.$watch(g, m.setInvalid), p.$parsers.push(c), p.$formatters.push(c), i.on("input", s), h || i.on("focus", function(t) {
                        e.nextTick(function() {
                            m.setFocused(!0)
                        })
                    }).on("blur", function(t) {
            ...
            return {
                ...
                compile: function(a, d) {
                    ...
                    function h(e, a, d, c) {
                        ...
                        h || u.length || p && p.addEventListener("keypress", f), a.off("click"), a.off("keypress"), 1 == u.length && p && a.children().eq(0).on("click", function(e) {
                            ...
                            p && p.removeEventListener("keypress", f)
                        })
                    }
    ...
    function() {
        function e(e, o, r, i, a, d) {
            function c(a, c) {
                ...
                return p = o.supplant(p, [u, a.html()]), a.empty().append(s), a.append(p), c.tabindex || c.$set("tabindex", 0),
                    function(a, c, s, l) {
                        function m() {
                        ...
                        if ($) {
                            ...
                            if ($.input && c.find("md-select-header").find("input")[0] !== $.input[0]) throw new Error("<md-input-container> can only have *one* child <input>, <textarea> or <select> element!");
                            $.input = c, $.label || i.expect(c, "aria-label", c.attr("placeholder")), a.$watch(w, $.setInvalid)
                        }
                        var x, N, _;
                        if (f(), r(c), s.name && A) {
                        ...
                        C.$render = function() {
                            ...
                            if (y.setIsPlaceholder(!e), s.mdSelectedText) e = d(s.mdSelectedText)(a);
                            else {
                        ...
                        }, k || (c.on("focus", function(e) {
                            $ && $.element.hasClass("md-input-has-value") && $.setFocused(!0)
                        }), c.on("blur", function(e) {
                            M && (M = !1, N.isOpen && e.stopImmediatePropagation()), N.isOpen || ($ && $.setFocused(!1), h())
                        ...
                        s.$observe("ngMultiple", function(e) {
                            ...
                            t.isString(e) && (e = !0), E !== n && E === e || (E = e, e ? c.attr({
                                "aria-disabled": "true"
                            }).removeAttr("tabindex").off("click", b).off("keydown", g) : c.attr({
                                tabindex: s.tabindex,
                                "aria-disabled": "false"
                            }).on("click", b).on("keydown", g))
            ...
            function a(r, i, a) {
                ...
                l.optNodeForKeyboardSearch = function(e) {
                    ...
                    if (l.ngModel = n, l.modelBinding = o, n.$options && n.$options.trackBy) {
                        ...
                        return t.isObject(e) ? "object_" + (e.$$mdSelectId || (e.$$mdSelectId = ++s)) : e
                    };
            ...
            function r(o, r, i, a) {
                function d(e, t, n) {
                    ...
                    var r = m.hashGetter(t, o),
                        i = m.hashGetter(e, o);
                    s.hashKey = i, s.value = e, m.removeOption(r, s), m.addOption(i, s)
                }
                ...
                var s = a[0],
                    m = a[1];
                m.isMultiple && (r.addClass("md-checkbox-enabled"), r.prepend(l.clone())), t.isDefined(i.ngValue) ? o.$watch(i.ngValue, d) : t.isDefined(i.value) ? d(i.value) : o.$watch(function() {
                    return r.text().trim()
                }, d), i.$observe("disabled", function(e) {
                    e ? r.attr("tabindex", "-1") : r.attr("tabindex", "0")
                }), o.$$postDigest(function() {
                    i.$observe("selected", function(e) {
                        t.isDefined(e) && ("string" == typeof e && (e = !0), e ? (m.isMultiple || m.deselect(Object.keys(m.selected)[0]), m.select(s.hashKey, s.value)) : m.deselect(s.hashKey), m.refreshViewValue())
                    })
                }), e.attach(o, r), c(), o.$on("$destroy", function() {
                    m.removeOption(s.hashKey, s)
                })
            }
                ...
                function v(e, n, o) {
                    var m, u = n[0],
                        ...
                        $ = {
                            ...
                            top: c,
                            bottom: E.height - c,
                            right: E.width - c - (s.floatingScrollbars() ? 16 : 0)
                        },
                        y = {
                            top: v.top - $.top,
                            left: v.left - $.left,
                        ...
                        w = d(n, b),
                        x = r(o.loadingAsync);
                    m = x ? b.firstElementChild || b : A ? A : k.length ? k[0] : T.length ? T[0] : b.firstElementChild || b, b.offsetWidth > C ? b.style["max-width"] = C + "px" : b.style.maxWidth = null, M && (b.style["min-width"] = v.width + "px"), w && g.classList.add("md-overflow");
                    var N = m;
        ...
        var c = 8,
            s = 0,
            l = t.element('<div class="md-container"><div class="md-icon"></div></div>');
            ...
            function u(d, u, p, h) {
                ...
                function g(e) {
                    var t = o.findFocusTarget(u) || o.findFocusTarget(u, "[md-sidenav-focus]") || u,
                        n = u.parent();
                    return n[e ? "on" : "off"]("keydown", v), k[e ? "on" : "off"]("click", M), e && (y = m[0].activeElement), b(e), C = l.all([e ? a.enter(k, n) : a.leave(k), a[e ? "removeClass" : "addClass"](u, "md-closed")]).then(function() {
                        d.isOpen && t && t.focus()
                    })
                }
                ...
                i(u), i.inherit(k, u), u.on("$destroy", function() {
                    k.remove(), h.destroy()
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, s) {
            ...
            function m(o, c, l, m) {
                ...
                function p(e) {
                    Y = parseFloat(e), c.attr("aria-valuemin", e), u()
                }

                function h(e) {
                    K = parseFloat(e), c.attr("aria-valuemax", e), u()
                }
                ...
                function g() {
                    c.attr("aria-disabled", !!P)
                }

                function b() {
                    if (t.isDefined(l.mdDiscrete) && !t.isUndefined(G)) {
                        if (0 >= G) {
                            var e = "Slider step value must be greater than zero when in discrete mode";
                            throw s.error(e), new Error(e)
                        }
                        var o = Math.floor((K - Y) / G);
                        if (!X) {
                            X = t.element("<canvas>").css("position", "absolute"), j.append(X);
                            var r = n.getComputedStyle(j[0]);
                            Q = X[0].getContext("2d"), Q.fillStyle = r.backgroundColor || "black"
                        }
                        var i = v();
                        X[0].width = i.width, X[0].height = i.height;
                        for (var a, d = 0; o >= d; d++) a = Math.floor(i.width * (d / o)), Q.fillRect(a - 1, 0, 2, i.height)
                    }
                }

                function E() {
                    Z = z[0].getBoundingClientRect()
                }
                ...
                function M(e) {
                    if (!P) {
                        var t;
                        e.keyCode === i.KEY_CODE.LEFT_ARROW ? t = -G : e.keyCode === i.KEY_CODE.RIGHT_ARROW && (t = G), t && ((e.metaKey || e.ctrlKey || e.altKey) && (t *= 4), e.preventDefault(), e.stopPropagation(), o.$evalAsync(function() {
                            $(m.$viewValue + t)
                        }))
                    }
                }
                ...
                function $(e) {
                    m.$setViewValue(C(A(e)))
                }

                function y() {
                    isNaN(m.$viewValue) && (m.$viewValue = m.$modelValue);
                    var e = (m.$viewValue - Y) / (K - Y);
                    o.modelValue = m.$viewValue, c.attr("aria-valuenow", m.$viewValue), T(e), B.text(m.$viewValue)
                }

                function C(e) {
                    return t.isNumber(e) ? Math.max(Y, Math.min(K, e)) : void 0
                }

                function A(e) {
                    if (t.isNumber(e)) {
                        var n = Math.round((e - Y) / G) * G + Y;
                ...
                function T(e) {
                    e = I(e);
                    var t = 100 * e + "%";
                    q.css("width", t), U.css("left", t), c.toggleClass("md-min", 0 === e), c.toggleClass("md-max", 1 === e)
                }

                function k(e) {
                    if (!P) {
                        c.addClass("md-active"), c[0].focus(), E();
                ...
                function w(e) {
                    if (!P) {
                        c.removeClass("md-dragging md-active");
                        var t = R(O(e.pointer.x)),
                            n = C(A(t));
                        o.$apply(function() {
                            $(n), y()
                ...
                function x(e) {
                    P || (J = !0, e.stopPropagation(), c.addClass("md-dragging"), H(e))
                }

                function N(e) {
                    J && (e.stopPropagation(), H(e))
                }
                ...
                function H(e) {
                    ee ? D(e.pointer.x) : S(e.pointer.x)
                }
                ...
                l.$observe("disabled", function(e) {
                    P = r.parseAttributeBoolean(e, !1), g()
                });
                var F = t.element(c[0].querySelector(".md-thumb")),
                    B = t.element(c[0].querySelector(".md-thumb-text")),
                    U = F.parent(),
                    z = t.element(c[0].querySelector(".md-track-container")),
                    q = t.element(c[0].querySelector(".md-track-fill")),
                    j = t.element(c[0].querySelector(".md-track-ticks")),
                    V = r.throttle(E, 5e3);
                t.isDefined(l.min) ? l.$observe("min", p) : p(0), t.isDefined(l.max) ? l.$observe("max", h) : h(100), t.isDefined(l.step) ? l.$observe("step", f) : f(1), d.register(c, "drag"), c.on("keydown", M).on("$md.pressdown", k).on("$md.pressup", w).on("$md.dragstart", x).on("$md.drag", N).on("$md.dragend", _), setTimeout(u, 0);
                var W = e.throttle(u);
                t.element(n).on("resize", W), o.$on("$destroy", function() {
                    t.element(n).off("resize", W)
                }), m.$render = y, m.$viewChangeListeners.push(y), m.$formatters.push(C), m.$formatters.push(A);
                var Y, K, G, X, Q, Z = {};
                E();
                var J = !1,
                    ee = t.isDefined(l.mdDiscrete)
            }
            return {
                scope: {},
                require: "?ngModel",
    ...
    function() {
        function e(e, o, r, i, a) {
            function d(e) {
                ...
                function d(e) {
                    var t = e.element[0];
                    for (e.top = 0, e.left = 0; t && t !== p[0];) e.top += t.offsetTop, e.left += t.offsetLeft, t.offsetParent && (e.right += t.offsetParent.offsetWidth - t.offsetWidth - t.offsetLeft), t = t.offsetParent;
            ...
            function o(e, n, o, i) {
                function a(t, a, d) {
                    ...
                    return a = o.extractElementByName(a, "md-toast", !0),
                        d.element = a, d.onSwipe = function(e, t) {
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, s) {
            function l(d, l, p) {
                ...
                function $() {
                    return w.append(l), i.hasComputedStyle(l, "display", "none") ? (d.visible = !1, void l.detach()) : (C(), void t.forEach([l, k], function(e) {
                ...
                var T = i.getParentWithPointerEvents(l),
                    k = t.element(l[0].getElementsByClassName("md-content")[0]),
            ...
            if (!(e === this.scrollOffset || e > this.scrollSize - this.size)) {
                ...
                if (t) {
                    var n = Math.max(0, Math.floor(e / t) - c),
                        o = (this.isHorizontal() ? "translateX(" : "translateY(") + n * t + "px)";
    ...
    function() {
        function e(e, o, d, c, s, l, m, u, p, h) {
            ...
            function g() {
                ...
                }, u > h && m.height - s.bottom - i < r ? (c.top = "auto", c.bottom = h + "px", c.maxHeight = Math.min(r, s.top - m.top - i) + "px") : (c.top = u - E + "px", c.bottom = "auto", c.maxHeight = Math.min(r, m.bottom + d.scrollTop() - s.bottom - i) + "px"), ue.$.scrollContainer.css(c), d.nextTick(n, !1)
            }
            ...
            function I(t, n) {
                se.index = z(), t !== n && B(e.selectedItem).then(function(o) {
                    t !== o && (e.selectedItem = null, t !== n && _(), X() ? de() : (se.matches = [], q(!1), te()))
                })
            }
            ...
            function P(e) {
                switch (e.keyCode) {
                    ...
                    case c.KEY_CODE.UP_ARROW:
                        ...
                        break;
                    case c.KEY_CODE.TAB:
                        if (k(), se.hidden || se.loading || se.index < 0 || se.matches.length < 1) return;
                        Z(se.index);
                        break;
            ...
            function ee(n) {
                function o(t) {
                    t && (t = h.when(t), Ee++, q(!0), d.nextTick(function() {
            ...
            var se = this,
                ...
                be = 0,
                Ee = 0;
            return Q("hidden", A, !0), se.scope = e, se.parent = e.$parent, se.itemName = le[0], se.matches = [], se.loading = !1, se.hidden = !0, se.index = null, se.messages = [], se.id = d.nextUid(), se.isDisabled = null, se.isRequired = null, se.isReadonly = null, se.hasNotFound = !1, se.keydown = P, se.blur = O, se.focus = L, se.clear = J, se.select = Z, se.listEnter = T, se.listLeave = k, se.mouseUp = w, se.getCurrentDisplayValue = G, se.registerSelectedItemWatcher = S, se.unregisterSelectedItemWatcher = D, se.notFoundVisible = ae, se.loadingIsVisible = K, f()
        }
    ...
    function() {
        ...
        function r(n, o, r, i, a, d) {
            function c(e) {
                if (e = e || "", M[e]) return r.when(l(M[e]));
                if ($.test(e) || y.test(e)) return h(e).then(m(e)); - 1 == e.indexOf(":") && (e = "$default:" + e);
                var t = n[e] ? u : p;
                return t(e).then(m(e))
            }
            ...
            function m(e) {
                return function(t) {
                    return M[e] = g(t) ? t : new b(t, n[e]), M[e].clone()
                }
            }
    ...
    function() {
        function e(e, o, r, i, a, d, c, s, l, m) {
            ...
            function _(e, t) {
                se || (ce.focusIndex = ce.selectedIndex = e), ce.lastClick = !0, t && ce.noSelectClick || d.nextTick(function() {
            ...
            function K() {
                ...
                }), t.element(le.paging).css("width", Math.ceil(e) + "px")
            }
