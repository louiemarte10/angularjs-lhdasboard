<?php
 ...
 px_login::init();
 $config= array();
$config['title'] = "Linkedhelper Dashboard Total Records";
$config['api_name'] = 'Linkedhelper Dashboard Total Records';
// $config['auth'] = true;
$gui = new px_gui($config);
$gui->head();
$gui->topnav();
$conn_main = new mysqli(config::get_server_by_name('main'), "app_pipe", "a33-pipe", "callbox_pipeline2");
