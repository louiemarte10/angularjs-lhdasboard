...
function generate() {
    ...
    if(choose_report == 'save_n_send'){
       if(select_date == 'Date Range'){
          window.open('save-and-send.php?hierarchy_tree_id='+select_dept+'&date_from='+from_datepicker+'&date_to='+to_datepicker, '_blank');
       } 
      else if(select_date == 'Today'){
         window.open('save-and-send.php?hierarchy_tree_id='+select_dept+'&date_from='+dateToday+'&date_to='+dateToday, '_blank');
       } 
      else if(select_date == 'Yesterday'){
         window.open('save-and-send.php?hierarchy_tree_id='+select_dept+'&date_from='+dateYesterday+'&date_to='+dateYesterday, '_blank');
       }
      else if(select_date == 'This Week'){
         window.open('save-and-send.php?hierarchy_tree_id='+select_dept+'&date_from='+thisweekMon+'&date_to='+thisweekSun, '_blank');
       
       }
      else if(select_date == 'Last Week'){
         window.open('save-and-send.php?hierarchy_tree_id='+select_dept+'&date_from='+lastweekMon+'&date_to='+lastweekSun, '_blank');
